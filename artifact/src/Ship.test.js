...
QUnit.test("Ship properties Firespray-31", assert => {
...
QUnit.test("Ship properties TIE Fighter", assert => {
...
QUnit.test("Ship properties X-Wing", assert => {
...
QUnit.test("required properties", assert => {
  EnumUtilities.values(Ship).forEach(ship => {
