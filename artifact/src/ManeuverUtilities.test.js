...
QUnit.test("dialToManeuver() 1FG", assert => {
  // Setup.
  const dial = "1FG";
...
QUnit.test("dialToManeuver() 2TW", assert => {
  // Setup.
  const dial = "2TW";
...
QUnit.test("dialToManeuver() 4KR", assert => {
  // Setup.
  const dial = "4KR";
...
QUnit.test("dialToManeuver() 2LR", assert => {
  // Setup.
  const dial = "2LR";
...
QUnit.test("dialToManeuver() 3ER", assert => {
  // Setup.
  const dial = "3ER";
