...
const APPEND_V2 = ["blackSunAce", "blackSunAssassin", "captainJostero", "cartelMarauder", "countessRyad", "daggerSquadronPilot", "dalanOberos_starViper", "deathfire", "felsWrath", "gammaSquadronVeteran", "gemmerSojan", "genesisRed", "glaiveSquadronPilot", "inaldra", "jakeFarrell", "jessPava", "keyanFarlander", "lieutenantLorrir", "neraDantels",
  "nienNunb", "poeDameron_hotr", "prototypePilot", "quinnJast", "saberSquadronPilot", "snapWexley", "soontirFel", "sunnyBounder", "tetranCowall", "thweek", "tomaxBren", "turrPhennir", "viktorHel"];
...
{
   const shipName = card.ship.toLowerCase().replace(/[.()]/g, "").replace(/[ /]/g, "-");
   return R.concat("ships/", R.concat(card.faction, R.concat("/", R.concat(shipName, ".png"))));
};

// xws values.
const OPTIONS = R.pipe(
   R.assoc("appendFaction", ["bobafett", "captainnym", "chewbacca", "chewbacca-swx57", "fennrau", "hansolo", "hansolo-swx57", "kathscarlet"]),
   R.assoc("appendHotr", ["poedameron-swx57"]),
   R.assoc("appendShip", ["dalanoberos", "ezrabridger", "herasyndulla", "kyloren", "maarekstele", "sabinewren", "zeborrelios"]),
