...
QUnit.test("Maneuver properties Bank Left 1 Easy", function(assert)
{
...
{
   EnumTest.keys(assert, Maneuver, 63, Maneuver.BANK_LEFT_1_EASY_1BG, Maneuver.TURN_RIGHT_3_STANDARD_3YW);
});
