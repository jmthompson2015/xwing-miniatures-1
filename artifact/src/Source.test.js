...
QUnit.test("Source properties A-wing Expansion Pack", function(assert)
{
...
{
   EnumTest.keys(assert, Source, 63, Source.A_WING_EXPANSION_PACK, Source.Z_95_HEADHUNTER_EXPANSION_PACK);
});

QUnit.test("required properties", function(assert)
{
   EnumUtilities.values(Source).forEach(function(source)
   {
