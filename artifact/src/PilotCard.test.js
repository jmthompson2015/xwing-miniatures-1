...
QUnit.test("PilotCard properties Academy Pilot", assert => {
...
QUnit.test("PilotCard properties Bounty Hunter", assert => {
...
QUnit.test("PilotCard properties Dutch Vander", assert => {
...
QUnit.test("PilotCard properties Rookie Pilot", assert => {
...
QUnit.test("required properties", assert => {
  EnumUtilities.values(PilotCard).forEach(pilot => {
