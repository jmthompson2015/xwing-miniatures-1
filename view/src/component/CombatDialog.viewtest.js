...
gameState = R.assocPath(["combatInstances", combatId, "defenseDiceKeys"], defenseDiceKeys, gameState);

const combatInstance1 = gameState.combatInstances[combatId];
const abilities1 = [createAbility("DiceModification", XMA.DiceModification.DEFENSE_SPEND_EVADE), createAbility("DiceModification", XMA.DiceModification.DEFENSE_SPEND_FOCUS)];
