...
QUnit.test("incrementNextCombatId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextCombatId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextCombatId());

   // Verify.
   assert.equal(store.getState().nextCombatId, 2);
});
...
QUnit.test("incrementNextConditionId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextConditionId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextConditionId());

   // Verify.
   assert.equal(store.getState().nextConditionId, 2);
});
...
QUnit.test("incrementNextDamageId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextDamageId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextDamageId());

   // Verify.
   assert.equal(store.getState().nextDamageId, 2);
});
...
QUnit.test("incrementNextPilotId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextPilotId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextPilotId());

   // Verify.
   assert.equal(store.getState().nextPilotId, 2);
});
...
QUnit.test("incrementNextSquadId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextSquadId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextSquadId());

   // Verify.
   assert.equal(store.getState().nextSquadId, 2);
});
...
QUnit.test("incrementNextUpgradeId()", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root);
   assert.equal(store.getState().nextUpgradeId, 1);

   // Run.
   store.dispatch(ActionCreator.incrementNextUpgradeId());

   // Verify.
   assert.equal(store.getState().nextUpgradeId, 2);
});
