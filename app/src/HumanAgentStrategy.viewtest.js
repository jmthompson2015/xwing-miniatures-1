...

{
  ...
  HumanAgentStrategy.chooseManeuvers(pilotInstances, pilotToValidManeuvers, "panel1").then(
    pilotToManeuver => console.log(`pilotToManeuver = ${JSON.stringify(pilotToManeuver)}`)
  );
}

{
  ...
  HumanAgentStrategy.chooseWeaponAndDefender(
    ...
    "panel2"
  ).then(({ attackerId, weaponKey, defenderId }) =>
