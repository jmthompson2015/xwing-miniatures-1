...
const AgentState = XMS.AgentState;
...
TestData.createGameState = function()
{
   ...
   const statBonuses11 = PilotUtils.createStatBonuses(pilotInstances[1].upgrades.map(upgradeId => upgradeInstances[upgradeId].upgradeKey));
   pilotInstances[1] = R.assoc("statBonuses", statBonuses11, pilotInstances[1]);
   const statBonuses33 = PilotUtils.createStatBonuses(pilotInstances[3].upgrades.map(upgradeId => upgradeInstances[upgradeId].upgradeKey));
