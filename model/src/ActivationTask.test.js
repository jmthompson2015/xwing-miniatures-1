...
QUnit.test("doIt() Start", function(assert)
{
   ...
   ActivationTask.doIt(store).then(callback);
});

QUnit.test("doIt() Reveal Dial", function(assert)
{
   // Setup.
   const store = initializeStore();
...
QUnit.test("doIt() Set Template", function(assert)
{
   // Setup.
   const store = initializeStore();
   store.dispatch(ActionCreator.setActivationQueue([2, 1, 3]));
...
QUnit.test("doIt() Execute Maneuver", function(assert)
{
   // Setup.
   const store = initializeStore();
   store.dispatch(ActionCreator.setActivationQueue([2, 1, 3]));
...
QUnit.test("doIt() Check Pilot Stress", function(assert)
{
   // Setup.
   const store = initializeStore();
   store.dispatch(ActionCreator.setActivationQueue([2, 1, 3]));
...
QUnit.test("doIt() Perform Action query", function(assert)
{
   // Setup.
   const store = initializeStore();
   store.dispatch(ActionCreator.setActivationQueue([2, 1, 3]));
...
QUnit.test("doIt() Perform Action response", function(assert)
{
   // Setup.
   const store = initializeStore();
   store.dispatch(ActionCreator.setActivationQueue([2, 1, 3]));
...
QUnit.test("doIt() Full Cycle", function(assert)
{
   ...
   // Run.
   const done = assert.async();
   ActivationTask.doIt(store).then(callback1);
});

////////////////////////////////////////////////////////////////////////////////
function initializeStore()
{
   return Redux.createStore(Reducer.root, TestData.createGameState());
}
...
{
   const activationQueue = store.getState().activationQueue;
