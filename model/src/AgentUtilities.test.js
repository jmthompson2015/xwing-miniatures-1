...
QUnit.test("determineValidManeuvers() X-Wing", function(assert)
{
   // Setup.
...
QUnit.test("determineValidShipActions() X-Wing", function(assert)
{
   // Setup.
   const shipKey = Ship.X_WING;
...
QUnit.test("determineWeaponToRangeToDefenders() out of range", function(assert)
{
   // Setup.
...
QUnit.test("determineWeaponToRangeToDefenders() Dark Curse", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root, TestData.createGameState());
   ...
   // Run.
   const result = AgentUtilities.determineWeaponToRangeToDefenders(attackerInstance, store.getState());
...
QUnit.test("determineWeaponToRangeToDefenders() Luke Skywalker", function(assert)
{
   // Setup.
   const store = Redux.createStore(Reducer.root, TestData.createGameState());
   const position1 = XMS.PositionState.create(
